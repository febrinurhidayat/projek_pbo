...
public class DataBarang extends javax.swing.JFrame {
    ...
    private void autonumber(){
        try {
            ...
            String sql = "SELECT * FROM barangg ORDER BY ID_Barang DESC";
    ...
    public void cariData(){
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "Select * from barangg where Jenis like '%" + jTextField1.getText() + "%'" +
                    "or Ukuran like '%" + jTextField1.getText() + "%'";
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE barangg SET Nama_Barang = ?, Jenis = ?, Ukuran = ?, HargaBeli = ?, HargaJual = ?, Stok = ? WHERE ID_Barang = ?";
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (pernyataan== JOptionPane.OK_OPTION) {
            try {
                Connection c = koneksi.getKoneksi();
                String sql = "DELETE FROM barangg WHERE ID_Barang = ?";
                PreparedStatement p = c.prepareStatement(sql);
                p.setString(1, id);
                p.executeUpdate();
                p.close();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "INSERT INTO BARANGG VALUES (?, ?, ?, ?, ?, ?, ?)";
            PreparedStatement p = c.prepareStatement(sql);
            p.setString(1, id);
            p.setString(2, nama);
            p.setString(3, jenis);
