    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < baris; i++) {
                ...
                String updateStokQuery = "UPDATE Barangg SET Stok = Stok - ? WHERE ID_Barang = ?";
                PreparedStatement updateStokStatement = c.prepareStatement(updateStokQuery);
                updateStokStatement.setInt(1, jumlahBarang);
                updateStokStatement.setString(2, idBarang);
                updateStokStatement.executeUpdate();

                // Menyimpan transaksi rinci
                String sql = "INSERT INTO penjualanrinci(NoFaktur, ID_Barang, Nama_Barang, Jumlah, Harga, Total) VALUES('"
                        + noTransaksi + "','" + idBarang + "','" + jTable1.getValueAt(i, 2)
                        + "','" + jumlahBarang + "','" + jTable1.getValueAt(i, 4) + "','" + jTable1.getValueAt(i, 5)
                        + "')";
                PreparedStatement p = c.prepareStatement(sql);
                p.executeUpdate();
                p.close();
